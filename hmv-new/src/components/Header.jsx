...
export default function Header() {
  ...
  return (
    <>
      <motion.nav
        layout
        className={`fixed z-50 left-1/2 -translate-x-1/2 overflow-hidden flex justify-between items-center transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] ${isScrolled
